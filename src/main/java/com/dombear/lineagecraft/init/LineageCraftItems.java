...
import com.dombear.lineagecraft.items.ItemSoulShot.Type;
...
public class LineageCraftItems {
	...
	/*
	public static final Item ewd = new ItemEwd("ewd");
	public static final Item ead = new ItemEad("ead");
...
//	public static Item amuletOfLost;
	...
	public static void init() {
		amuletOfLost = new ItemAmuletOfLost();
		ead = new ItemEad();
		ewd = new ItemEwd();
		
		soulshotw = new ItemSoulShot(Type.WOOD);
		soulshots = new ItemSoulShot(Type.STONE);
		soulshoti = new ItemSoulShot(Type.IRON);
		soulshotg = new ItemSoulShot(Type.GOLD);
		soulshotd = new ItemSoulShot(Type.DIAMOND);
	}
	*/
