...
public class ContainerEnchantArmor  extends Container{
	
	public final InventoryEnchantArmor inventory;
	...
	public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int index){
		...
		if (slot != null && slot.getHasStack() && Minecraft.getMinecraft().world.isRemote)
		{
			...
			else
			{
				...
				if (itemstack1.getItem() instanceof ItemEnchantScrollArmor)
				{
